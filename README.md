...
> **Fork con port a Sega Dreamcast.**
> Este árbol añade un backend de Dreamcast (KallistiOS/PVR) a TheXTech: renderer
> PVR con texturas pre-convertidas, mando Maple, audio por AICA y música por
> streaming Ogg, y empaquetado a CDI arrancable.
>
> Documentación del port: [`platforms/dreamcast/README.md`](platforms/dreamcast/README.md)
> y el handoff técnico en [`platforms/dreamcast/HANDOFF.md`](platforms/dreamcast/HANDOFF.md).
>
> Los assets del juego no se distribuyen aquí (ver `.gitignore`).
